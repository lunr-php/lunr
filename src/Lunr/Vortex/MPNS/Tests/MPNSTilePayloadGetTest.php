...
class MPNSTilePayloadGetTest extends MPNSTilePayloadTest
{
    ...
    {
        $file     = __DIR__ . '/../../../../../tests/statics/vortex/mpns_tile_title.xml';
    ...
    {
        $file     = __DIR__ . '/../../../../../tests/statics/vortex/mpns_tile_background_image.xml';
    ...
    {
        $file     = __DIR__ . '/../../../../../tests/statics/vortex/mpns_tile_count.xml';
    ...
    {
        $file     = __DIR__ . '/../../../../../tests/statics/vortex/mpns_tile_back_background_image.xml';
    ...
    {
        $file     = __DIR__ . '/../../../../../tests/statics/vortex/mpns_tile_back_title.xml';
    ...
    {
        $file     = __DIR__ . '/../../../../../tests/statics/vortex/mpns_tile_back_content.xml';
