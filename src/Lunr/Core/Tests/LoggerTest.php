...
class LoggerTest extends PHPUnit_Framework_TestCase
{
    ...
    public function setUp()
    {
        ...
        $this->logger_reflection = new ReflectionClass('Lunr\Core\Logger');
    }
     ...
     *
     * @covers Lunr\Core\Logger::construct_error_message
     */
     ...
     * @covers Lunr\Core\Logger::log_error
     */
     ...
     *
     * @expectedException PHPUnit_Framework_Error_Warning
     * @covers Lunr\Core\Logger::log_errorln
     */
