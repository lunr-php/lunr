...
class MySQLConnectionBaseTest extends MySQLConnectionTest
{
     ...
     *
     * @covers Lunr\DataAccess\MySQLConnection::get_new_dml_query_builder_object
     */
    public function testGetNewDMLQueryBuilderObjectReturnsObject()
    {
        $value = $this->db->get_new_dml_query_builder_object();

        $this->assertInstanceOf('Lunr\DataAccess\DatabaseDMLQueryBuilder', $value);
        $this->assertInstanceOf('Lunr\DataAccess\MySQLDMLQueryBuilder', $value);
    }
