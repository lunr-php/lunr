...
use Lunr\DataAccess\DatabaseConnection;
 ...
 * @subpackage Tests
 * @author     Heinz Wiesinger <heinz@m2mobi.com>
 * @covers     Lunr\DataAccess\DatabaseConnection
 */
class DatabaseConnectionTest extends PHPUnit_Framework_TestCase
{
    ...
    public function setUp()
    {
        ...
        $this->db_reflection = new ReflectionClass('Lunr\DataAccess\DatabaseConnection');
    }
     ...
     * @covers  Lunr\DataAccess\DatabaseConnection::set_readonly
     */
