...
use Lunr\Libraries\Spwn\ResqueJobDispatcher;
use Lunr\Mocks\Libraries\Spwn\MockResque;
 ...
 * @subpackage Tests
 * @author     Olivier Wizen <olivier@m2mobi.com>
 * @covers     Lunr\Libraries\Spwn\ResqueJobDispatcher
 */
class ResqueJobDispatcherTest extends PHPUnit_Framework_TestCase
{
    ...
    {
        $this->resque = new MockResque();

        $this->dispatcher_reflection = new ReflectionClass('Lunr\Libraries\Spwn\ResqueJobDispatcher');
     ...
     *
     * @covers Lunr\Libraries\Spwn\ResqueJobDispatcher::__construct
     */
     ...
     *
     * @covers Lunr\Libraries\Spwn\ResqueJobDispatcher::dispatch
     */
     ...
     *
     * @covers Lunr\Libraries\Spwn\ResqueJobDispatcher::get_job_id
     */
     ...
     *
     * @covers Lunr\Libraries\Spwn\ResqueJobDispatcher::set_queue
     */
     ...
     * @covers       Lunr\Libraries\Spwn\ResqueJobDispatcher::set_track_status
     */
